const ReponseMessages = {
  genericError: 'Algo salio mal. Intentalo mas tarde',
  genericSuccess: 'Petición exitosa',
  errorCreacion:' No se ha podido generar la fila',
  ...
  exitoBorrado:'Se ha eliminado la fila con exito',
